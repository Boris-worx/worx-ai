  ...
  const getDefaultTemplate = (type: string): string => {
    ...
    const templates: Record<string, any> = {
      ...
      LineType: {
        ...
        erpOrderLineType: 'stock',
        eRP: 'online',
        isActive: true,
        isSkuTypeDefault: true,
        enforceQuantityOfOne: false,
        isInstallOnly: false
      },
      LineTypes: {
        lineTypeId: Date.now(),
      ...
      ServiceRequest: {
        ...
        status: 'pending',
        assignedTo: null,
        createdDate: today + 'T00:00:00.000Z',
        dueDate: nextMonth + 'T00:00:00.000Z',
        completedDate: null,
        notes: null
      },
      WorkflowCustomer: {
        workflowCustomerId: 'WFC-' + Date.now(),
        customerId: '',
        workflowId: '',
        workflowName: '',
        currentStage: '',
