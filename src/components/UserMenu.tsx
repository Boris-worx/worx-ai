...
import { LogOut, RefreshCw, UserCircle, TestTube } from 'lucide-react';
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          {/* Test Azure AD Role Processing */}
          {user.isAzureAuth && (
            <DropdownMenuItem onClick={() => setShowAzureTestDialog(true)} className="cursor-pointer">
              <TestTube className="mr-2 h-4 w-4" />
              <span className="text-sm">Test Azure Roles</span>
            </DropdownMenuItem>
          )}
          <DropdownMenuSeparator />
